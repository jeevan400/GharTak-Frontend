import { Archive, CalendarClock, Car, Check, Eye, Store, X } from "lucide-react";
  ...
  return (
    <div className="h-full overflow-y-auto">
      ...
      <div className="p-4 grid grid-cols-4 gap-4 ">
        <Card className={`!mx-0`}>
          <Card.Header className={`flex justify-between`} icon={<div className='bg-red-600/20 p-2 rounded-lg'><Archive size={18} /></div>}>
                <div className='text-[12px] text-violet-600 font-bold bg-violet-600/20 h-fit py-1 px-2 rounded-full'>+12%</div>
          </Card.Header>
          <Card.Body>
        ...
        <Card className={`!mx-0`}>
          <Card.Header className={`flex justify-between`} icon={<div className='bg-blue-600/20 p-2 rounded-lg'><Store size={18} color="#1D4ED8"/></div>}>
                <div className='text-[12px] text-red-800 font-bold bg-red-600/20 h-fit py-1 px-2 rounded-full'>+8%</div>
          </Card.Header>
          <Card.Body>
        ...
        <Card className={`!mx-0`}>
          <Card.Header className={`flex justify-between`} icon={<div className='bg-red-600/25 p-2 rounded-lg'><CalendarClock size={18} color="#DC2626"/></div>}>
                <div className='text-[12px] text-red-600 font-bold bg-red-600/25 h-fit py-1 px-2 rounded-full'>High Priority</div>
          </Card.Header>
          <Card.Body>
            <h1 className='text-sm font-semibold text-gray-600'>PENDING ORDERS</h1>
                <p className='text-lg font-bold'> 1,024</p>
          </Card.Body>
        </Card>
        <Card className={`!mx-0`}>
          <Card.Header className={`flex justify-between`} icon={<div className='bg-indigo-600/25 p-2 rounded-lg'><Eye size={18} color="#4F46E5" /></div>}>
                <div className='text-[12px] text-blue-600 font-bold bg-blue-600/25 h-fit py-1 px-2 rounded-full'>Real-time</div>
          </Card.Header>
          <Card.Body>
            <h1 className='text-sm font-semibold text-gray-600'>ACTIVE USERS</h1>
                <p className='text-lg font-bold'> 1,024</p>
          </Card.Body>
        </Card>
      </div>
      <div className="">
        <Card className={`!p-0`}>
          ...
          <button className="text-lg font-light text-red-900">View All</button>
          </Card.Header>
          <Card.Body>
                  ...
                  <tr className="hover:bg-red-900/5 transition-all duration-200 ease-in cursor-pointer">
                    <td className="flex gap-4 px-4 py-2">
                      <div className="h-[50px] w-[50px]">
                        <img className="w-full h-full rounded-full" src={request.image} alt="" />
                      </div>
                      <div>
                        <h1 className="text-lg font-bold capitalize">{request.name}</h1>
                        <p className="text-sm font-medium text-gray-600">{request.email}</p>
                      </div>
                    </td>
                    <td>
                      {request.phone}
