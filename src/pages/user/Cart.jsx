...
function Cart() {
  ...
  return (
    ...
    console.log("cart " , cartItem)
      ...
      {!error && cartItem?.items?.length > 0 && (
        <div>
          <p>Total Items: {cartItem.totalItems}</p>
      ...
      <div className="h-full w-full grid grid-cols-12 gap-4 px-4">
        <div className="col-span-8 py-4">
          ...
          <div>
            <button onClick={()=> navigate(-1)} className="flex items-center gap-2 text-red-900 font-medium text-lg"><ArrowLeft size={20}/> Continue Shopping</button>
          </div>
